...
$q="UPDATE `lama` SET `quest_08` = '".$_POST['file']."' WHERE `lama_id`=".$_SESSION['lama_id'];
$res = $link->query($q);
?>
...
<div id='centr-q'>
    <div id="quest" >
        ...
        <form method="post" action="9.php">
            ...
            <input id="wo1" class="checkbox" type="radio" name="work" value="0" />
            <label for="wo1">Скопирую на флэшку и поработаю дома</label><br>
            <input id="wo2" class="checkbox" type="radio" name="work" value="0" />
            <label for="wo2">Отправлю себе на почту и поработаю дома</label><br>
            <input id="wo3" class="checkbox" type="radio" name="work" value="1" />
            <label for="wo3">Останусь на работе или приду завтра пораньше</label><br>
            <input id="wo4" class="checkbox" type="radio" name="work" value="1" />
            <label for="wo4">Попрошу коллег помочь мне</label><br>
            <input id="wo5" class="checkbox" type="radio" name="work" value="0" />
