...
<div id='centr-q'>
    <div id="quest" >
        ...
        <form method="post" action="2.php">
            ...
            <label for="ch3">@345rtyFD</label> <br>
            ...
            <label for="but4">Нажать Ctrl+Alt+Del, нажать сменить пароль, сообщить системным администраторам, чтобы сменили пароль</label><br>
             <br>
